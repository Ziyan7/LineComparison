...
public class LineComparisonProblem 
{
	...
	public static void main(String[] args) {
		...
		//creating object
		LineComparisonProblem l1=new LineComparisonProblem(x1,y1,x2,y2);
		LineComparisonProblem l2=new LineComparisonProblem(p1,q1,p2,q2);
		double length;
		length=l1.length();
		...
		//compareTo function is used to compare lengths
